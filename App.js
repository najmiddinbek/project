...
export default function App() {
    const [url, setUrl] = useState('https://chortoq-mdm.vercel.app');
    ...
    registerNNPushToken(14355, '2uOoOwaNANizcVr6ZIabMi');
    ...
    useEffect(() => {
        async function getUnreadNots() {
            let unreadCount = await getUnreadNotificationInboxCount(14355, '2uOoOwaNANizcVr6ZIabMi');
    ...
    const handleGoToInbox = async () => {
        let notifications = await getNotificationInbox(14355, '2uOoOwaNANizcVr6ZIabMi');
